...
describe('getNewCasesByDay', () => {
  it(`returns the new cases on the given date in the given data`, () => {
    const data1 = [
      ...
      ['USA','North America','United States','2020-04-06',337635.0,25$398.0,9647.0,1146.0,1020.037,76.731,29.145,3.462,1958186.0,152008.0,5.916,0.459,139064.0,0.42,'units unclear (incl. non-PCR)',72.69,331002647.0,35.608,38.3,15.413,9.732,54225.446,1.2,151.089,10.79,19.1,24.6,,2.77,78.86]
    ]
